...
LOCAL_SRC_FILES := $(PJLIB_SRC_DIR)/alaw_ulaw.c $(PJLIB_SRC_DIR)/alaw_ulaw_table.c \
	...
	$(PJMEDIADEV_VIDEO_SRC_DIR)/ffmpeg_dev.c $(PJMEDIADEV_VIDEO_SRC_DIR)/sdl_dev.c \
	$(PJMEDIACODEC_SRC_DIR)/amr_sdp_match.c

# If not csipsimple, load default audio codecs loader from pjmedia
#zzc modify ifneq ($(MY_USE_CSIPSIMPLE),1)
...
LOCAL_SRC_FILES += $(PJ_ANDROID_SRC_DIR)/pjmedia-videodev/android_capture_dev.c
