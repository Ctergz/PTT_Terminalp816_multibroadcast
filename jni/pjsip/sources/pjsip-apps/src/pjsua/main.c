...
{
    { "init", "()I", (void*) init },
    { "login", "(Lcom/woasis/ptt/model/SipServer;Lcom/woasis/ptt/model/SipUser;)I", (void*) login },
    { "makeCall", "(Lcom/woasis/ptt/model/NumberInfo;)I", (void*) make_call },
    { "answer", "(I)I", (void*) answer },
    { "hangup", "(I)I", (void*) hangup },
    { "destroy", "()I", (void*) destroy },
    { "sendMessage", "(Ljava/lang/String;Ljava/lang/String;)I", (void*) send_message },
    { "getMember", "(Ljava/lang/String;)I", (void*) get_group_member },
    { "cancelPttRight", "(Ljava/lang/String;)I", (void*) cancel_ptt_right },
...
{
    static const char* kClassName = "com/woasis/ptt/jni/CallJni";
    jclass cls;
    ...
    if (cls == NULL)
    {
        PJ_LOG(1, (THIS_FILE, "Can't find class %s", kClassName));
        return -1;
    }
    /* register all the methods */
    if ((*env)->RegisterNatives(env, cls, gMethods, sizeof(gMethods) / sizeof(gMethods[0])) != JNI_OK)
    {
        PJ_LOG(1, (THIS_FILE, "Failed to register methods for %s", kClassName));
        return -1;
    }
    return JNI_TRUE;
}
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    {
        PJ_LOG(1, (THIS_FILE, "ERROR: GetEnv failed\n"));
    ...
    {
        PJ_LOG(1, (THIS_FILE, "ERROR: PlatformLibrary native registration failed"));
    }
