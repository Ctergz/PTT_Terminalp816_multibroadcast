...
/**************************************************************
* Copyright (C), 2012-201x, Woasis Tech. Co., Ltd.
* Project:   Woasis PTT 1.0
...
static void receive_group_info(ptt_group_info *group_info)
{
    ...
    rcvGrpInfo = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "receiveGroupInfo", "([Lcom/woasis/ptt/model/GroupInfo;)V");
...
static void receive_member_info(ptt_member_info *member_info, char *groupNum)
{
    ...
    constructorMethodId = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "<init>", "()V");
    obj_jni_callback = (*jni_env)->NewObject(jni_env, jni_callback_class, constructorMethodId);
    receiveMemberInfo = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "receiveMemberInfo", "(Ljava/lang/String;[Lcom/woasis/ptt/model/MemberInfo;)V");
...
static void multicast_invite_indicate(pj_str_t *group_num, pj_str_t *speaker)
{
    ...
    PJ_LOG(3, (THIS_FILE, "multicast_invite_indicate invite group_num : %s, speaker : %s\n",grp_num, speaker_num));
...
static void update_ptt_state(multicast_INFO *info)
{
    ...
    mUpdatePttStatus = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "updatePttState", "(Lcom/woasis/ptt/model/PttGroupStatus;)V");
...
static void receive_member_state_change(multicast_MemberState *member_info)
{
    ...
    constructorMethodId = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "<init>", "()V");
    obj_jni_callback = (*jni_env)->NewObject(jni_env, jni_callback_class, constructorMethodId);
    mReceiveMemberStateChange = (*jni_env)->GetMethodID(jni_env, jni_callback_class, "receiveMemberStateChange", "(Lcom/woasis/ptt/model/MemberInfo;)V");
