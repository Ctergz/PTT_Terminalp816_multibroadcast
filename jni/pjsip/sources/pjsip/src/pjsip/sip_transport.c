...
#include <pjsip/multicast_parser.h>
#endif
...
#if (PJSIP_EXTEND_ZED || PJSIP_EXTEND_WOASIS)
    if (tr->key.type == PJSIP_TRANSPORT_MULTICAST)
    {
        multicast_parse_rdata(current_pkt, msg_fragment_size, rdata);
