...
#define PJMEDIA_VIDEO_DEV_HAS_ANDROID_CAPTURE 1 //zzc add for android video 
#ifndef PJSIP_EXTEND_ZED
#define PJSIP_EXTEND_ZED   1 //zzc add for ZED
#endif
#undef PJSIP_EXTEND_ZED     //lxd add



#ifndef PJSIP_EXTEND_WOASIS
#define PJSIP_EXTEND_WOASIS  1 // lxd add for woasis
#endif
