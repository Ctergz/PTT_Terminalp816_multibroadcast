...
import com.woasis.ptt.model.CallState;
import com.woasis.ptt.model.EnumLoginState;
import com.woasis.ptt.model.GroupInfo;
import com.woasis.ptt.model.MemberInfo;
import com.woasis.ptt.model.PttGroupStatus;
import com.woasis.ptt.proxy.SipProxy;
import com.woasis.ptt.service.CallStateManager;
import com.woasis.ptt.service.PTTManager;
import com.woasis.ptt.service.PTTManager.PTT_KEY;
import com.woasis.ptt.service.PTTService;
import com.woasis.ptt.service.StateManager;
import com.woasis.ptt.ui.PTTActivity;
	...
	public void showCallState(CallState callState) {
		...
		if (pttUtil.checkIsGroupNum(callState.getNumber())) {
			...
			case PTTConstant.CALL_TALKING:
				...
				case PTTConstant.PTT_IDLE:// in case the CALL_RINGING received
											// after 403
					if (pttManager.ePttKeyStatus == PTT_KEY.PTT_KEY_UP && (!callManager.isbForceInSC())) {
						service.broadcastDebugInfo("invite is hanging");
						...
						pttManager.getCurrentPttState().setSpeakerNum(
								pttUtil.getSipUserFromPrefs(PTTService.instance.prefs).getUsername());
						pttManager.getCurrentPttState().setCallId(callState.getCallId());
						service.JNIUpdatePTTState(pttManager.getCurrentPttState());
						// service.playPttAlert(service,
						// PTTConstant.PTT_ALERT_ACCEPT);
					}
					break;
				default:
					break;
