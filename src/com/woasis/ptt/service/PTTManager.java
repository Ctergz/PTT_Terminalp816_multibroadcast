...
public class PTTManager {
	...
	public boolean isPttUIOnTop() {
		...
		return (PTTActivity.instance != null && "com.woasis.ptt.ui.PTTActivity".equals(PTTService.instance.getTopActivity()));
	}
	...
	public boolean isbPttErrorShowing() {
		if(bPttErrorShowing){
			if(!"com.woasis.ptt.ui.AlertActivity".equals(PTTService.instance.getTopActivity()))
			{
