...
import com.woasis.ptt.jni.JniCallback;
import com.woasis.ptt.jni.JniManager;
...
import com.woasis.ptt.ui.AlertActivity;
import com.woasis.ptt.ui.InCallScreenActivity;
import com.woasis.ptt.ui.MainPageActivity;
...
public class PTTService extends Service {
	...
	public void onDestroy() {
		...
		Intent intentTOHO = new Intent("com.woasis.action.start");
	...
	public void JNIUpdateRegisterState(EnumLoginState currentState, int state, int errorCode) {
		...
		case PTTConstant.REG_ED:
			...
			if (AlertActivity.instance != null || "com.woasis.ptt.ui.AlertActivity".equals(getTopActivity())) {
				AlertActivity.instance.finish();
			}
