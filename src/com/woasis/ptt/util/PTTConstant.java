...
public class PTTConstant {
	...
	/* intent action */
	public static final String ACTION_REGISTER = "com.woasis.ptt.action.REGISTER";
	public static final String ACTION_INIT = "com.woasis.ptt.action.INIT";
	public static final String ACTION_DEINIT = "com.woasis.ptt.action.DEINIT";
	public static final String ACTION_GETGROUPDATA = "com.woasis.ptt.action.PULLGRP";
	public static final String ACTION_ALERT = "com.woasis.ptt.action.ALERT";
	public static final String ACTION_CALLSTATET = "com.woasis.ptt.action.CALLSTATE";
	...
	public static final String ACTION_DYNAMIC_REGRP = "com.woasis.ptt.action.DYNAMIC_REGRP";
	...
	public static final String ACTION_COMMAND = "com.woasis.ptt.action.COMMAND";
	public static final String ACTION_DEBUG = "com.woasis.ptt.action.DEBUG";
	public static final String ACTION_NUMBER_KEY1 = "android.intent.action.key_number";
	public static final String ACTION_NUMBER_KEY2 = "com.woasis.ptt.action.KEY_NUMBER";
	public static final String ACTION_INPUT_NUMBER = "com.woasis.ptt.dialpage.neednum";
	...
	public static final String TAG_PREFIX = "WOASIS-PTT";
...
/*	public static final String DEBUG_LOG_ROOT = "/data/data/com.woasis.ptt/files";
	public static final String DEBUG_LOG_PATH = "/data/data/com.woasis.ptt/files/log/";
	public static final String DEBUG_PCAP_PATH = "/data/data/com.woasis.ptt/files/pcap/";*/
