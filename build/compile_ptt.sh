 ...
 do_javac()
{
	...
	${JAVA_HOME}/bin/javac -encoding UTF-8 -target 1.6 -bootclasspath ${android_jar} -d ${CLASS_OUT_DIR} ${SRC_DIR}/${package}/ui/*.java ${SRC_DIR}/${package}/db/*.java  ${SRC_DIR}/${package}/exception/*.java ${SRC_DIR}/${package}/jni/*.java ${SRC_DIR}/${package}/model/*.java ${SRC_DIR}/${package}/service/*.java ${SRC_DIR}/${package}/proxy/*.java  ${SRC_DIR}/${package}/util/*.java  ${GEN_DIR}/com/woasis/ptt/R.java
